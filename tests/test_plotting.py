"""This file contains the tests for  plotting library"""
...
def test_plot_data():
    "A test for the checking the input data in process_data() function"
...
def test_convert_data():
    """A test for checking the converted data on the convert_data() function"""
